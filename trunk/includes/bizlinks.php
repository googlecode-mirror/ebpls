...
<a href='index.php?part=4&class_type=Permits&itemID_=1221&owner_id=$get_info[0]&com=Drop&permit_type=$tag&stat=Transfer/Dropping&busItem=Franchise'  class=subnavwhite> Drop</a></td>";
        ...
        print "<td>
<a href='index.php?part=4&class_type=Permits&itemID_=1221&owner_id=$get_info[0]&com=$get_info[7]&permit_type=$tag&stat=$get_info[7]&business_id=$get_info[1]&busItem=Business&addbiz=update&bizcom=Select' class=subnavwhite>Edit Application</a>&nbsp";
...
?>
|
<a href='#' class=subnavwhite onclick='ViewAppHis("<?php echo $get_info[0]; ?>","<?php echo $get_info[1]; ?>");'>Application History</a>
<?php
echo "</td>";
