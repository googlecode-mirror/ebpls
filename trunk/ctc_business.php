...
$pdf->SetFont('Arial','B',12);
	...
	ctc_incorporation_date, ctc_tax_due, ctc_acct_code
...
$pdf->Cell(80,3,'',0,0,'L');
$pdf->SetFont('Arial','',4);
$pdf->Cell(40,3,$resulta[10],0,0,'C');
$pdf->Cell(40,3,$rp,0,1,'R');

$gr=((int)($resulta[10]/5000)*2);
...
$pdf->Cell(80,3,'',0,0,'L');
$pdf->SetFont('Arial','',4);
$pdf->Cell(40,3,$resulta[11],0,0,'C');
...
$pdf->Cell(40,3,'',0,0,'C');
$pdf->SetFont('Arial','',4);
$pdf->Cell(40,3,$grandtotal,0,1,'R');
